...
LINKEDIN_SEARCH_QUERIES = ["junior machine learning engineer", "machine learning engineer", "ML engineer"]
LINKEDIN_LOCATION = "Coimbatore"
LINKEDIN_GEO_ID = 101031506 # Coimbatore
...
CAREERS_FUTURE_SEARCH_QUERIES = ["junior machine learning engineer", "machine learning engineer", "ML engineer"]
